                  ...
                  return ListView.builder(
                    ...
                    InkWell(
                          ...
                          child: Stack(
                            ...
                            elevation: 8,
                            color: Colors.white, child: Padding(padding: EdgeInsets.all(32),
                            child: Column( crossAxisAlignment: CrossAxisAlignment.start,
                            children: [ SizedBox(height:100), Text(state.categoryList[index].name, style: TextStyle(
                              fontWeight: FontWeight.w600, fontSize: 32, color:Colors.black),
                              textAlign: TextAlign.left),
                              Text('Altrue Cause', style: TextStyle(fontSize:22, fontWeight: FontWeight.w300),
                              textAlign: TextAlign.left,),
                              SizedBox(height:30),
                              Row(
                                children: [ Text('Learn More', textAlign: TextAlign.right,style:TextStyle(
                                color:Colors.amber)
